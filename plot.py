...
df=pd.read_csv('XRD_profiles_2D.csv')
f=df.T
...
ax = sb.heatmap(read, xticklabels=500,cmap ='YlOrRd', cbar_kws={'label': 'Intensity Map'})#, linewidths = 0.02),RdYlGn # for more check https://www.python-graph-gallery.com/92-control-color-in-seaborn-heatmaps
"""
options are:
rainbow,
...
#fig.savefig(figname, format='eps', dpi=600,bbox_inches='tight')
fig.savefig(out_fig_name, bbox_inches='tight',dpi=600)
